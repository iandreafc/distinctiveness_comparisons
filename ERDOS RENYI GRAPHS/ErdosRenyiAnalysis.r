...
plotcor (correlations, "ERDOSRENYICorrUnweighted", "Random Erdos-Renyi Networks - Unweighted")
...
plotcor (correlations, "ERDOSRENYICorrWeighted", "Random Erdos-Renyi Networks - Weighted")
